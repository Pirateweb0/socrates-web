...
export function Footer(){
    return (
        <div className="w-full bg-[#61677A] pt-5 pb-14 flex flex-col md:flex-row justify-evenly text-white">
            <div>
                <p className="text-white font-bold">REFERENCIAS</p>
                <div className='flex gap-2 my-3 box-border'>
